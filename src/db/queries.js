...
export const taskQueries = {
  ...
  async updateStatus(id, status, claimedByAgentId = undefined) {
...
export const deliverableQueries = {
  ...
  async requestRevision(deliverableId, revisionNotes) {
    const result = await db
      .update(deliverables)
...
export const reviewQueries = {
  async findByAgent(agentId, { limit = 10, offset = 0 } = {}) {
    return db
      .select({
        review: reviews,
