  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-md-bg px-4">
      <div className="w-full max-w-sm">
        <h1 className="mb-1 text-2xl font-medium text-md-fg">Create account</h1>
        <p className="mb-6 text-sm text-md-on-surface-variant">
          Get started with TaskHive
        </p>

        {emailSent && (
          <div className="mb-4 rounded-2xl bg-md-success-container px-4 py-3 text-sm text-md-success">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div>
            <label className="mb-1 block text-sm font-medium text-md-on-surface-variant">Name</label>
            <input
              type="text"
              value={name}
        ...
        <p className="mt-6 text-center text-sm text-md-on-surface-variant">
          ...
          <Link href="/auth/login" className="font-medium text-md-primary hover:underline">
            Sign in
          </Link>
        </p>
      </div>
